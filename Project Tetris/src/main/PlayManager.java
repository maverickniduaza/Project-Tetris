...
public class PlayManager {
    ...
    private Mino pickMino(){
        ...
        // Pick a random mino/block pieces
        Mino mino = null;
    ...
    public void update(){
        ...
        if(currentMino.active == false){
            ...
            //when a mino become inactive, check if the line/s can be deleted/clear
        checkDelete();
        }
        else{
            currentMino.update();
    ...
    private void checkDelete(){
        ...
        while(x < right_x && y < bottom_y){
            ...
            if(x == right_x){
                ...
                // so we can delete them or clear that part
                if(blockCount == 12) {
                    ...
                    // a line has been deleted so it needs to slide down blocks that are above it
                    for(int i = 0; i < staticBlocks.size(); i++){
    ...
    public void draw(Graphics2D g2){
        ...
        g2.drawRect(left_x-4, top_y-4, WIDTH+8,HEIGHT+8); // To draw a rectangle

        // Draw Next Mino/Pieces Frame
        int x = right_x + 100;
        int y = bottom_y - 200;
        ...
        g2.drawString("Project Tetris", x+20, y);
    }
}
